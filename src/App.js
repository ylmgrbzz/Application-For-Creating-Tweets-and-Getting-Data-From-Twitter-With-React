...
import { ppImageLoader } from './loaders';
...
export default function App() {
  ...
  const [tweet, setTweet] = useState("Test Tweet'idir ve @ylmgrbzz tarafından #ylmgrbzz github profili için oluşturulmuştur.");
  ...
  const ppImageHandle = e => {
    const file = e.target.files[0];
    const reader = new FileReader();
    reader.addEventListener('load', function() {
      setppImage(this.result);
    });
      ...
      <div className="tweet-settings">
        ...
        <ul>
          ...
          <li>
            ...
            <input type="file" className="input" onChange={ppImageHandle} />
          </li>
          <li>
            <label>Retweet</label>
            <input
      ...
      <div className="tweet-container">
        ...
        <div className="fetch-info">
          <input
            ...
            onChange={e => setUsername(e.target.value)}
          />
          <button onClick={fetchTwitterInfo}>Bilgileri Al</button>
        </div>

        <div className="tweet" ref={tweetRef}>
          <div className="tweet-author">
            {(ppImage && <img src={ppImage} />) || <ppImageLoader />}
            <div>
              <div className="name">
